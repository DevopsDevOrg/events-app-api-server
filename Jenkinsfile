...
pipeline {
   ...
   environment {
        ...
        imageName = 'ahershiv/api-server-image:v1.0.0'
        dockerImage = ''
        }
    stages {
        stage('Get Source') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/DevopsDevOrg/events-app-api-server.git'
        ...
        stage('Deploy Image') {
         ...
         stage('get k8s credentials') {
            ...
            steps {
                ...
                sh 'gcloud container clusters get-credentials events-app-cluster --zone us-central1-c --project roidtc-july2022-u422'
            }
        }     
         stage('update k8s') {
             agent {
